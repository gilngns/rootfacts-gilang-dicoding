    ...
    <section class="camera-section">
      <div class="camera-container">
        ...
        <div id="model-progress-wrap" class="model-progress-wrap hidden">
          <p id="model-progress-label" class="model-progress-label">Menunggu Model... 0%</p>
        ...
        <div class="camera-controls">
          <button id="btn-toggle" class="capture-btn" type="button">
...
function generateResultState() {
  return `
    <div id="state-result" class="result-card result-main hidden">
      ...
      <div id="fun-fact-card" class="fun-fact-card">
        ...
        <div id="fun-fact-content">
          ...
          <button id="btn-copy" class="copy-btn" title="Salin fakta" type="button">
